...
import './attack-styles/singleProjectiles.css'
import { SingleProjectileProps } from "../../interfaces/SingleProjectileProps"


const SingleProjectile: React.FC<SingleProjectileProps> = ({moveType}) => {
    ...
    return (
        <div className="single-player-attack">
            <img src={selectedAttack} className="single-move-type" />
        </div>
    )
}

export default SingleProjectile;